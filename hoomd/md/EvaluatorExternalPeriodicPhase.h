...
#ifndef __EVALUATOR_EXTERNAL_PERIODICPHASE_H__
#define __EVALUATOR_EXTERNAL_PERIODICPHASE_H__
...
/*! \file EvaluatorExternalPeriodicPhase.h
...
/*! <b>General Overview</b>
    EvaluatorExternalPeriodicPhase is an evaluator to induce a periodic modulation on the concentration
...
*/
class EvaluatorExternalPeriodicPhase
    {
    public:
    ...
    */
    DEVICE EvaluatorExternalPeriodicPhase(Scalar3 X,
                                     const BoxDim& box,
    ...
    */
    ...
    static std::string getName()
        {
        return std::string("periodicphase");
        }
#endif
